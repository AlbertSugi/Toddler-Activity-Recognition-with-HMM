...
class HiddenMarkovModel():
    ...
    def emissionProbability(filename,participant,classifier,parameters,pklname):
        ...
        y =  data['Activity'].loc[(data.Participant.isin(participant))&(data.Activity.isin([101,103,104,201,301,302,303,304]))].tolist()
        Participant = participant
        
        Probability = []
        dataset =  data.loc[(data.Participant.isin(participant))&(data.Activity.isin([101,103,104,201,301,302,303,304]))]
